...
define config.name = _("TUSUR_BRUH")
...
define gui.about = _p("""
Игра была создана группой разработчиков-Студентов из ТУСУР:\n
Данил Плещев\n
Максим Деев\n
Владимир Сороковиков;\n
Наша игра создана, чтобы предать особенности студентческой жизни, через Визуальную Новеллу
""")
...
define build.name = "Game_for_TUSUR_BRUH"
...
define config.save_directory = "Beta_Game-1664206392"
