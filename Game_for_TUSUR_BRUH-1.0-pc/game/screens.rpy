...
screen main_menu():
    ...
    imagemap:
        ...
        hover "gui/menu_underline.png"
        
        hotspot(1613,780,280,55) action Start()
        hotspot(1613,850,280,55) action ShowMenu("load")
        hotspot(1613,920,280,55) action ShowMenu("preferences")
        hotspot(30,665,140,55) action ShowMenu("help")
        hotspot(1680,1000,155,55) action Quit(confirm=True)
        hotspot(35,735,130,55) action ShowMenu("about")
